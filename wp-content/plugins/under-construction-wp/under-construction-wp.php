...
define( 'SEED_UCP_PLUGIN_NAME', __( 'Under Construction', 'seed_ucp' ) ); // Plugin Name shows up on the admin settings screen.
define( 'SEED_UCP_VERSION', '1.0.0'); // Plugin Version Number. Recommend you use Semantic Versioning http://semver.org/
...
function seed_ucp_load_textdomain() {
    load_plugin_textdomain( 'seed_ucp', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
